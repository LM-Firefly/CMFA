                    ...
                    when (it) {
                        ...
                        AccessControlDesign.Request.SelectAll -> {
                            val all = withContext(Dispatchers.Default) {
                                design.appsList.map(AppInfo::packageName)
                            }
                        ...
                        AccessControlDesign.Request.SelectInvert -> {
                            val all = withContext(Dispatchers.Default) {
                                design.appsList.map(AppInfo::packageName).toSet() - selected
                            }
                        ...
                        AccessControlDesign.Request.Import -> {
                            ...
                            if (data != null && data.itemCount > 0) {
                                ...
                                val all = design.appsList.map(AppInfo::packageName).intersect(packages)
