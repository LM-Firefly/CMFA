...
import com.github.kr328.clash.design.dialog.MapTextFieldDialog
    ...
    return suspendCancellableCoroutine { ctx ->
        ...
        val composeView = ComposeView(context).apply {
            setContent {
                MapTextFieldDialog(
                    ...
                    valueValue = valueState.value,
                    onKeyChange = { keyState.value = it },
        ...
        val dialog = MaterialAlertDialogBuilder(context)
            ...
            .setPositiveButton(R.string.ok) { _, _ ->
                val k = keyState.value.trim()
                val v = valueState.value.trim()
